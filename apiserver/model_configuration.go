...
// Configuration - Each configuration defines access to one Kentix One device.
type Configuration struct {
	...
	// IP or hostname of the Kentix One device
	...
	// List of Eliona project ids for which this device should collect data. For each project id all smart devices are automatically created as an asset in Eliona. The mapping between Eliona is stored as an asset mapping in the Kentix One app.
