...
func (r *configurationR) GetDevices() DeviceSlice {
	if r == nil {
		return nil
	}
	return r.Devices
...
func (o *Configuration) Devices(mods ...qm.QueryMod) deviceQuery {
...
func (configurationL) LoadDevices(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration interface{}, mods queries.Applicator) error {
...
func (o *Configuration) AddDevicesG(ctx context.Context, insert bool, related ...*Device) error {
	return o.AddDevices(ctx, boil.GetContextDB(), insert, related...)
}
...
// Appends related to o.R.Devices.
// Sets related.R.Configuration appropriately.
func (o *Configuration) AddDevices(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Device) error {
	var err error
